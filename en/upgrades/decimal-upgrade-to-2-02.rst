...
The fourth decimal upgrade of the standard was proposed to occur
...
|                | off date       |                |                |
+----------------+----------------+----------------+----------------+
| The TAG        | These are      | Usually within | 21 September   |
...
| community.     |                |                |                |
+----------------+----------------+----------------+----------------+
| Consultation   | Community      | Over a two     | 7 October      |
...
|                | left out.      |                |                |
+----------------+----------------+----------------+----------------+
| Proposals      | During this    | within 1 week  | 19 October     |
| refined and    | time the       |                |                |
...
| used).         |                |                |                |
+----------------+----------------+----------------+----------------+
| Final          | Community can  | within 1 week  | 30 November    |
| version of     | scrutinise     |                |                |
