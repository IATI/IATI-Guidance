...
Note: The current standard upgrade process will adopt the widely-adopted `Semantic Versioning specification <https://semver.org/>`__ at the next major upgrade.
