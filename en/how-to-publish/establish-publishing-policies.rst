...
If your organisation also reports to the DAC then the Common Standard Implementation Schedule should be `downloaded and used <https://github.com/IATI/IATI-Implementation-Schedule/blob/master/files/template-commonstandard/Implementation-Schedule-for-the-common-standard-ENG.xls>`__
